...
const TopDoctor = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 py-16 text-gray-800 md:mx-10'>
            ...
            <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-t-6 px-3 sm:px-0'>
                {doctors.slice(0, 10).map((item, index) => (
                    <div
                        key={index}
                        onClick={() => { navigate(`/appointment/${item._id}`); scrollTo(0, 0); }} // Fixed navigation
                    ...
                    >
                        ...
                        <div className='p-4'>
                            ...
                            <p className='text-gray-900 txet-lg font-medium'>{item.name}</p>
