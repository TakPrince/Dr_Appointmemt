...
const DoctorProfile = () => {
    ...
    const { courrency } = useContext(AppContext)
        ...
        <div>
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    {/* doc info name,degrre and expries */}
                    ...
                    {/* doctor about */}
                    <div >
                        <p className='flex flex-col  gap-1 text-sm font-medium text-neutral-800 mt-3'>About <p className='text-sm text-gray-600 max-w-[700px] mt-1'>{profileData.about}</p></p>
                    </div>
                    <p className='text-gray-600 font-medium mt-4'>
                        Appointment fee : <span className='text-gray-800'>{courrency} {isEdit ? <input type="number" onChange={(e) => setProfileData(prev => ({ ...prev, fee: e.target.value }))} value={profileData.fee} /> : profileData.fee}</span>
                    </p>
